          ...
          <div className="welcomeImgBox">
            ...
            {isLoggedIn ? (
              <div className="home-welcomeText">
                {String(user.apartName).slice(30, 34) + "아파트"}
                <br />
                {user.name + "님"}
                <br />
                우리 이웃들을 만나보세요!
        ...
        {isLoggedIn ? (
          <div>
            <div className="home-section2-1">
              <span className="home-calendarText">
                이번 달에는 아파트에 무슨 일정이 잡혀 있을까요?
                <br />
                이번 달의 일정을 확인하세요!
              </span>
            ...
            <div className="home-section2-2">
              ...
              <div className="home-notice">
                {notice.map((val) => {
                  return (
                    <Link
                      to={"/noticePostView/" + String(val.id)}
                      style={{ textDecoration: "none" }}
                    >
                      <div key={val.index} className="box">
                        <div className="home-notice-map">
                          <div className="home-notice-map-title">
                            {val.title}
                          </div>
